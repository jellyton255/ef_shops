...
---@field shopItems table<string, table<string, ShopItem>> map of shop names to a map of item names to ShopItem
---@field locations table<string, ShopLocation> map of shop names to ShopLocation
return {
